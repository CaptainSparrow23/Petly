...
const Profile = () => {
 ...
 return (
  ...
  <View className="flex-1 mt-3 bg-gray-500">
   ...
   <View className="flex-2 rounded-t-3xl bg-primary-300 shadow-lg pt-2 pb-32">
        ...
        <View className="w-[48%]">
         ...
         >
          ...
          <View className="flex-1">
           <Text className="text-lg font-bold font-bold text-black-900" numberOfLines={1}>
            {item.name}
           </Text>
           <Text className="text-xs text-black-200 capitalize">{item.type}</Text>
