      ...
      <View className="flex-row items-center justify-between px-4 py-4">
        ...
        >
          {isSaving ? (
            ...
            <Text
              className={`text-lg font-rubik-medium ${hasChanges ? "text-blue-500" : "text-gray-400"}`}
            >
              Done
            </Text>
          )}
      ...
      >
        <View className="rounded-3xl border border-gray-100 bg-white px-8 py-8 shadow-sm">
          ...
          >
            ...
            <Text className="mt-4 text-2xl font-rubik-bold text-black">
          ...
          <View className="px-2 py-2">
            <View className="flex-row items-center justify-center">
              <View className="mr-3">
                <Text className="mt-2 ml-8 text-lg font-rubik text-gray-800">
                  @ {username || "Not set"}
                </Text>
              </View>
              <TouchableOpacity
      ...
      >
        ...
        >
          <TouchableOpacity
            ...
            onPress={(e) => e.stopPropagation()}
          >
            <Text className="text-xl font-rubik-bold text-gray-900 mb-4 text-center">
              Edit Username
            </Text>
            ...
            <View className="flex-row justify-between mt-4 gap-3">
              ...
              >
                <Text className="text-md font-rubik-medium text-gray-600">
                  Cancel
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
